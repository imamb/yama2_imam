	...
	public void configure(HttpSecurity http) throws Exception {
		...
		http
			...
			.authorizeRequests()
				...
				.antMatchers("/api/news","/api/news/**").fullyAuthenticated()
				.antMatchers("/api/category","/api/category/**").fullyAuthenticated()
				.antMatchers("/api/jurusan","/api/jurusan/**").fullyAuthenticated()
				.antMatchers("/api/siswa","/api/siswa/**").fullyAuthenticated()
				.antMatchers("/api/kelas","/api/kelas/**").fullyAuthenticated()
